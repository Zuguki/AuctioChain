...
const SearcherAuction = () => {
    ...
    return (
        <div>
            ...
            <SearchInput title='' name='searcher' width='large' changeValue={a} />
            <div className={styleSearcher.selects}>
                <BaseSelect title='Фильтровать по:' name='filter' selectors={['1', '2', '3']} changeValue={a} />
                <BaseSelect title='Сортировать по:' name='sort' selectors={['1', '2', '3']} changeValue={a} />
            </div>
            <Hr width='large'/>
