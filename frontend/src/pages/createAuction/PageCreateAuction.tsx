        ...
        <form
            ...
            <div>
                ...
                <div>
                    ...
                    {err && <p className={styleCreateAuction.error}>{err.message}</p>}
                </div>
                <FormInput title='Название аукциона' name='name' error={err} changeValue={logicFormValue}
                           blurError={blurError}/>
                <FormTextArea title='Описание аукциона' name='description' error={err} blurError={blurError}
                              changeValue={logicFormValue}/>
                <DateInput title='Дата окончания' name='dateEnd' error={err} changeValue={logicFormValue}
                           blurError={blurError}/>
                <div className={styleCreateAuction.positionButton}>
                    <BaseButton disabled={loading} type='submit' onClick={postAuction}>Создать аукцион</BaseButton>
                </div>
            </div>
        </form>
    );
